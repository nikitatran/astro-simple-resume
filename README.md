...
- Section navigation
- [Prettier plugin](https://github.com/withastro/prettier-plugin-astro) for formatting
...
- Keyboard accessible (for accessing interactables with `tab`)
...
### Note regarding site deployment
